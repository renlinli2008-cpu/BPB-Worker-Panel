⚠️ 免责声明
本免责声明适用于 GitHub 上的 “edgetunnel” 项目（以下简称“本项目”），项目链接为：https://github.com/renlinli2008-cpu/BPB-Worker-Panel 。
...
| 变量名 | 示例 | 必填 | 备注 |
|--------|---------|-|-----|
| UUID |VLESS UUID |✅| 面板登录密码 |
| TR_PASS | Trojan Password|✅| 快速订阅密钥，访问`/CMLiussss`即可快读订阅。 |
